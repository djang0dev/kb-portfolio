...
<div class="swiper swiper-projects">
    <div class="swiper-wrapper">
		...
		<?php
		/*
		 *  After looping through a separate query, this function restores the $post global to the current post in the main query. A toujours utiliser!!
		sinon ça déglingue tout https://developer.wordpress.org/reference/functions/wp_reset_postdata/
		*/
		wp_reset_postdata(); ?>
    </div>
