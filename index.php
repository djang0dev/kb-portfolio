        ...
        <div class="content-block">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h1 class="heading">
                                <span>Hi, <img class="rounded-pill" src="assets/images/author-sm.jpg" alt="*"> I'm Mogen</span>
                                <span>digital designer</span>
                                <span>based in <img src="assets/images/country.jpg" alt="*"> Belgium</span>
                            </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row justify-content-center gy-4 gx-6">
                        <div class="col-xl-5 col-lg-8">
                            ...
                            <p class="lead">As a Digital Designer, I am here to make you stand out in the digital world.
            ...
            <footer>
                <div class="container bg-light-soft">
                    <div class="block" style="background-image:url(assets/images/footer-bg.jpg)">
                        <div class="row gx-0 gx-md-4 gy-4 justify-content-center">
                            <div class="col-lg-5 text-center text-lg-start order-1 order-lg-0">
                                ...
                                <p class="small">&copy; Copyright, Riazz Mogen</p>
                            </div>
                            <div class="col-lg-5 text-center text-lg-end order-0 order-lg-1">
                                ...
                                <p class="small">Contact at <a class="btn-link text-white" href="mailto:hello@mogen.io">hello@mogen.io</a>
                                </p>
                            </div>
                        </div>
                    </div>
